...
| 内容范围 | 章节页规划 11 张卡；仅前三张有故事，APK 实际含三章七图 | 保留规划资料，只把有完整地图的三章七图列为发布内容 |

原 APK 的纯红画面不是随机资源损坏，而是作者设置的章节年代地点牌。它缺少标题且颜色过
亮，容易被玩家误认为渲染故障，因此采用“保留信息、改善表达”的修复。

11 张章节卡与七张可加载地图并不是同一种计数。原版第 4–11 张卡没有章节正文和开场
演出，四份额外地图配置草稿又缺少 prefab；在模拟器强行进入第 3 张卡对应的缺失地图，
原版会在过场后停在全黑画面。维护版因此只开放经过实际加载和通关验证的七图，并用自动
门禁防止未发布占位被误加入关卡选择。详细证据见
[原版章节完整性专项核验](original-eleven-card-content-audit-2026-07-29.md)。
