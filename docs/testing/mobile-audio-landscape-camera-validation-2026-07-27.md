...
| 手机开场和启动布局紊乱 | 多种 Canvas 设计尺寸混用；旧五页 Spine 片头在 2.4.15 原生渲染器中后段仍会出现错误几何 | 所有主场景统一 fixed-height 横屏适配；1.1.3 原生端使用稳定历史插画、标题、原配乐、原字幕和 52 秒时序，Web/编辑器保留原 Spine。最终结论见 2026-07-28 专项报告 |
