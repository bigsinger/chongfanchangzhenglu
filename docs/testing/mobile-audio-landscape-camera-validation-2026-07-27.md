...
| 手机开场和启动布局紊乱 | 多种 Canvas 设计尺寸混用；当时观察到 Spine 片头附件在 2.4.15 原生宽屏下变换错位 | 所有主场景统一 fixed-height 横屏适配；当时以静态插画兜底。后续已确认根因是图集缩放遗漏 `orig/offset`，1.1.2 恢复完整 Spine 片头，见 2026-07-28 专项报告 |
