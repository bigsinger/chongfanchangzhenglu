...
| Effort | M |
| Location | Relative: `tools/modernize-android-project.js:217-221`, `tools/modernize-android-project.js:265-272`; absolute: `tools\modernize-android-project.js:217`, `tools\modernize-android-project.js:265`. Packaged inputs: `resources/cocos2d-x/cocos/platform/android/java/libs/okhttp-3.12.7.jar` and `...\okio-1.15.0.jar`. |
...
| Severity | **MEDIUM** |
| Effort | S-M |
| Location | Relative: `tools/modernize-android-project.js:68-75`, `tools/modernize-android-project.js:8`, `tools/build-android-release.ps1:3-6`, `.github/workflows/quality-gates.yml:20`, `.github/workflows/quality-gates.yml:23`; absolute: `tools\modernize-android-project.js:68`, `.github\workflows\quality-gates.yml:20`. |
...
| Severity | **LOW** |
| Effort | S |
| Location | Relative: `tools/modernize-android-project.js:274-276`; absolute: `tools\modernize-android-project.js:274`. Generated source: `build/jsb-link/frameworks/runtime-src/proj.android-studio/libcocos2dx/AndroidManifest.xml:3`. |
...
| Location | Artifact: `dist\chongfanchangzhenglu-1.1.0-2026072701-release.apk` and `.aab`. Current source: relative `assets/Scripts/ConfigRepair.js:41`, `assets/Scripts/SaveManager.js:18`, `assets/Scripts/SaveManager.js:109`, `package.json:9`; absolute `assets\Scripts\ConfigRepair.js:41`, `...\SaveManager.js:109`. Pipeline: `tools/build-android-release.ps1:217-264`. |
...
| Severity | **MEDIUM** |
| Effort | S |
| Location | Relative: `tools/build-android-release.ps1:59-65`, `tools/apply-runtime-fixes.js:434-438`; absolute: `tools\build-android-release.ps1:59`, `tools\apply-runtime-fixes.js:434`. |
...
| Severity | **MEDIUM** |
| Effort | M |
| Location | Relative: `settings/builder.json:13`, `settings/builder.panel.json:8`, `tools/build-android.ps1:169-171`, `tools/build-android-release.ps1:68-72`, `tools/modernize-android-project.js:152-164`; absolute: `settings\builder.json:13`, `tools\modernize-android-project.js:152`. |
...
| Severity | **MEDIUM** |
| Effort | M |
| Location | Relative: `package.json:6-13`, `jsconfig.json:2-5`, `tools/check-syntax.js:7-16`, `tools/validate-game-config.js:153-178`, `.github/workflows/quality-gates.yml:27-49`, `tools/build-android-release.ps1:200`; absolute: `package.json:6`, `.github\workflows\quality-gates.yml:27`. |
...
| Severity | **HIGH** |
| Effort | L |
| Location | Relative: `project.json:6-8`, `tools/build-android-release.ps1:3`, `tools/build-android-release.ps1:115-130`, `tools/modernize-android-project.js:8`, `tools/modernize-android-project.js:156-157`; absolute: `project.json:6`, `tools\build-android-release.ps1:3`. |
...
| Location | Relative dependency inclusion: `tools/modernize-android-project.js:217-221`; absolute input: `resources/cocos2d-x/cocos/platform/android/java/libs/okhttp-3.12.7.jar`; absolute project script: `tools\modernize-android-project.js:217`. |
...
| Location | Relative dependency inclusion: `tools/modernize-android-project.js:217-221`; absolute project script: `tools\modernize-android-project.js:217`; absolute input: `resources/cocos2d-x/cocos/platform/android/java/libs/okio-1.15.0.jar`. |
...
| Location | Relative: `package.json:1-14`, `tools/modernize-android-project.js:217-221`; absolute: `package.json:1`, `tools\modernize-android-project.js:217`. |
...
| Location | Relative: `tools/modernize-android-project.js:68-75`, `.github/workflows/quality-gates.yml:20-23`, `tools/build-android-release.ps1:3-6`; absolute: `tools\modernize-android-project.js:68`, `.github\workflows\quality-gates.yml:20`. |
