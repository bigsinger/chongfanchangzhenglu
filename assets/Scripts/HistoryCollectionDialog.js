...
/**
 * 模块职责：展示已发现的长征史实条目与完成度。
 * 关键约束：只读取收藏状态，不在浏览界面修改主线进度。
 */
...
var i, n = this && this.__extends || (i = function (t, e) {
        ...
        var s = require("./GameState"), r = require("./PopupView"), c = require("./DialogManager"), l = cc._decorator, h = l.ccclass, d = l.property, p = function (t) {
            n(e, t);
            function e() {
