...
/**
 * 模块职责：展示章节完成信息并衔接下一段流程。
 * 关键约束：确认动作只提交一次，避免重复解锁或重复切场。
 */
...
var i, n = this && this.__extends || (i = function (t, e) {
        ...
        var s = require("./PopupView"), r = require("./AudioManager"), c = require("./DialogManager"), l = cc._decorator, h = l.ccclass, d = l.property, p = function (t) {
            n(e, t);
            function e() {
