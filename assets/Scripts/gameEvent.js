...
var i, n = this && this.__extends || (i = function (t, e) {
        ...
        var s = require("./ConfManager"), r = require("./GameData"), c = require("./SoundManage"), l = require("./ViewManager"), h = require("./itemDrop"), d = require("./loopDrop"), p = require("./timingEvent"), u = cc._decorator, m = u.ccclass, _ = (u.property,
            function (t) {
                n(e, t);
                function e() {
                ...
                e.selectClosestItem = function () {
                    ...
                    for (var l = 0; l < i.length; l++) {
                        var h = i[l], d = h && h.activeInHierarchy && h.getComponent("itemBox"), p = d && d.getOpType();
                        if (p) {
