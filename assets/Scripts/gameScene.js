        ...
        var s = require("./BaseView"), r = require("./ConfManager"), c = require("./GameData"), l = require("./SoundManage"), h = require("./ToolsManager"), d = require("./ViewManager"), p = require("./spineManager"), u = require("./gameEvent"), v = require("./SaveManager"), w = require("./ObjectiveManager"), m = cc._decorator, _ = m.ccclass, f = m.property, g = function (t) {
            ...
            e.prototype.resumeInterruptedDelayedEvents = function () {
                ...
                for (var i in this.itemMap) {
                    var n = this.itemMap[i], a = n && n.getComponent("itemBox"), s = a && a.getConf();
                ...
                for (var l in this.itemMap) {
                    var h = this.itemMap[l], d = h && h.getComponent("itemBox"), p = d && d.getConf();
            ...
            e.prototype.getInteractiveBubble = function (t) {
                ...
                for (var p in this.itemMap) {
                    var u = this.itemMap[p], m = u && u.getComponent("itemBox"), _ = m && m.node_bubble;
            ...
            e.prototype.scanTouchProximity = function () {
                ...
                for (var o in this.itemMap) {
                    var i = this.itemMap[o], n = i && i.activeInHierarchy && i.getComponent("itemBox");
            ...
            e.prototype.tryDeadTreeDescent = function (t) {
                ...
                var o = this.itemMap && this.itemMap[11], i = o && o.getComponent("itemBox"), n = i && i.getConf();
